...
# ------------------ LSTM-GARCH-VIX with Lookback 5 ------------------ #
...
# ------------------ Define Parameters ------------------ #
time_steps = 5  # Sequence length for intraday (5 x 15min = 75min window)
steps_per_day = 26
initial_train_size = 21 * steps_per_day  # ~1 month of intraday data
validation_size = 7 * steps_per_day  # ~1 week of intraday data
...
model_save_path = os.path.join(data_dir, "lstm_garch_vix_seq_length_5.weights.h5")
...
# Save results
results_path = os.path.join(data_dir, "results_lstm_garch_vix_lookback_5.csv")
